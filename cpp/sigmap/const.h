...
const sigmaos::sigmap::types::Tsize MAXGETSET =
    MBYTE;  // If need more than MaxGetSet, use Open/Read/Close interface
...
const sigmaos::sigmap::types::Tperm DMREAD =
    0x4;  // mode bit for read permission
const sigmaos::sigmap::types::Tperm DMWRITE =
    0x2;  // mode bit for write permission
const sigmaos::sigmap::types::Tperm DMEXEC =
    0x1;  // mode bit for execute permission
