...
GOARCH=x86_64 GOOS=linux go build -ldflags="-X ulambda/ninep.Target=aws -X ulambda/proc.Version=AAA" $RACE -o bin/user/spin-lambda cmd/user/spin-lambda/main.go
