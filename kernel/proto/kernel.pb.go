...
func (x *KillRep) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KillRep) ProtoMessage() {}

func (x *KillRep) ProtoReflect() protoreflect.Message {
	mi := &file_kernel_proto_kernel_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KillRep.ProtoReflect.Descriptor instead.
func (*KillRep) Descriptor() ([]byte, []int) {
...
var file_kernel_proto_kernel_proto_rawDesc = []byte{
	...
	0x64, 0x6f, 0x77, 0x6e, 0x52, 0x65, 0x70, 0x22, 0x1d, 0x0a, 0x07, 0x4b, 0x69, 0x6c, 0x6c, 0x52,
	0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x09, 0x0a, 0x07, 0x4b, 0x69, 0x6c, 0x6c, 0x52, 0x65,
	0x70, 0x42, 0x16, 0x5a, 0x14, 0x73, 0x69, 0x67, 0x6d, 0x61, 0x6f, 0x73, 0x2f, 0x6b, 0x65, 0x72,
...
var file_kernel_proto_kernel_proto_goTypes = []interface{}{
	...
	(*KillReq)(nil),                // 10: KillReq
	(*KillRep)(nil),                // 11: KillRep
}
