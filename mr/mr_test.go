...
func TestNewWordCount(t *testing.T) {
	...
	p, err := perf.NewPerf(proc.NewTestProcEnv(sp.ROOTREALM, nil, sp.NO_IP, sp.NO_IP, sp.NO_IP, "", false, false, false), perf.SEQWC)
	assert.Nil(t, err)
...
func TestMapper(t *testing.T) {
	...
	p, err := perf.NewPerf(proc.NewTestProcEnv(sp.ROOTREALM, nil, sp.NO_IP, sp.NO_IP, sp.NO_IP, "", false, false, false), perf.MRMAPPER)
	assert.Nil(t, err)
