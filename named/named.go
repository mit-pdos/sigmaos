...
var InitDir = []string{sp.TMPREL, sp.BOOTREL, sp.KPIDSREL, sp.SCHEDDREL, sp.PROCDREL, sp.UXREL, sp.UPROCDREL, sp.S3REL, sp.DBREL, sp.SIGMAMGRREL, sp.HOTELREL, sp.CACHEREL}
