...
var InitRootDir = []string{sp.TMPREL, sp.BOOTREL, sp.KPIDSREL, sp.SCHEDDREL, sp.UXREL, sp.S3REL, sp.DBREL, sp.HOTELREL, sp.CACHEREL, sp.IMGREL}

var InitDir = []string{sp.TMPREL, sp.HOTELREL, sp.CACHEREL, sp.IMGREL}
