...
func SrvDialNetProxy(started chan bool, ntrial int, npc *netproxyclnt.NetProxyClnt, addr *sp.Taddr, epType sp.TTendpoint) error {
...
func ClntDialNetProxy(ntrial int, npc *netproxyclnt.NetProxyClnt, ep *sp.Tendpoint) (string, error) {
