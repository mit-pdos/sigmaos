...
type ProcEnvProto struct {
	...
	IDStr           string                 `protobuf:"bytes,26,opt,name=iDStr,proto3" json:"iDStr,omitempty"`
}
...
func (x *ProcEnvProto) GetIDStr() string {
	if x != nil {
		return x.IDStr
	}
	return ""
...
var file_proc_proc_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x94, 0x06, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x63,
	...
	0x67, 0x6d, 0x61, 0x63, 0x6c, 0x6e, 0x74, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x44, 0x53, 0x74,
	0x72, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x69, 0x44, 0x53, 0x74, 0x72, 0x22, 0xa1,
