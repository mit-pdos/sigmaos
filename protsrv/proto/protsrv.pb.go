...
const (
	...
	WatchEventType_REMOVE WatchEventType = 1
)
...
type WatchEvent struct {
	...
	Type WatchEventType `protobuf:"varint,2,opt,name=type,proto3,enum=WatchEventType" json:"type,omitempty"`
}
...
func (x *WatchEventList) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
var file_spproto_srv_proto_protsrv_proto_rawDesc = []byte{
	...
	0x06, 0x52, 0x45, 0x4d, 0x4f, 0x56, 0x45, 0x10, 0x01, 0x42, 0x17, 0x5a, 0x15, 0x73, 0x69, 0x67,
	0x6d, 0x61, 0x6f, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x73, 0x72, 0x76, 0x2f, 0x70, 0x72, 0x6f,
