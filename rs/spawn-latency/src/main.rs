...
fn print_elapsed_time(db_pid: &str, msg: &str, start: SystemTime) {
...
fn main() {
    ...
    print_elapsed_time(&debug_pid, "proc.exec_proc", exec_time);
    print_elapsed_time(&debug_pid, "E2e spawn latency until main", spawn_time);
