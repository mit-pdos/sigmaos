...
type RegisterMSchedReq struct {
	...
	EndpointProto *sigmap.TendpointProto `protobuf:"bytes,4,opt,name=endpointProto,proto3" json:"endpointProto,omitempty"`
}

func (x *RegisterMSchedReq) Reset() {
	*x = RegisterMSchedReq{}
...
func (x *RegisterMSchedReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterMSchedReq) ProtoMessage() {}

func (x *RegisterMSchedReq) ProtoReflect() protoreflect.Message {
	mi := &file_sched_lcsched_proto_lcsched_proto_msgTypes[0]
...
// Deprecated: Use RegisterMSchedReq.ProtoReflect.Descriptor instead.
func (*RegisterMSchedReq) Descriptor() ([]byte, []int) {
	return file_sched_lcsched_proto_lcsched_proto_rawDescGZIP(), []int{0}
}

func (x *RegisterMSchedReq) GetKernelID() string {
	if x != nil {
		return x.KernelID
	}
	return ""
...
func (x *RegisterMSchedReq) GetMcpuInt() uint32 {
	if x != nil {
		return x.McpuInt
	}
	return 0
...
func (x *RegisterMSchedReq) GetMemInt() uint32 {
	if x != nil {
		return x.MemInt
	}
	return 0
...
func (x *RegisterMSchedReq) GetEndpointProto() *sigmap.TendpointProto {
	if x != nil {
...
type RegisterMSchedRep struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *RegisterMSchedRep) Reset() {
	*x = RegisterMSchedRep{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterMSchedRep) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterMSchedRep) ProtoMessage() {}

func (x *RegisterMSchedRep) ProtoReflect() protoreflect.Message {
	mi := &file_sched_lcsched_proto_lcsched_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterMSchedRep.ProtoReflect.Descriptor instead.
func (*RegisterMSchedRep) Descriptor() ([]byte, []int) {
...
var file_sched_lcsched_proto_lcsched_proto_rawDesc = []byte{
	...
	,
...
var file_sched_lcsched_proto_lcsched_proto_goTypes = []interface{}{
	(*RegisterMSchedReq)(nil),     // 0: RegisterMSchedReq
	(*RegisterMSchedRep)(nil),     // 1: RegisterMSchedRep
	(*sigmap.TendpointProto)(nil), // 2: TendpointProto
}
var file_sched_lcsched_proto_lcsched_proto_depIdxs = []int32{
	2, // 0: RegisterMSchedReq.endpointProto:type_name -> TendpointProto
...
func file_sched_lcsched_proto_lcsched_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sched_lcsched_proto_lcsched_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterMSchedReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sched_lcsched_proto_lcsched_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterMSchedRep); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
