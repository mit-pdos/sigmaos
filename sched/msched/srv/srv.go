...
import (
	...
	procproto "sigmaos/sched/msched/proc/proto"
...
func (msched *MSched) CheckpointProc(ctx fs.CtxI, req procproto.CheckpointProcRequest, res *procproto.CheckpointProcResponse) error {
	db.DPrintf(db.MSCHED, "CheckpointProc %v", req)
	if err := msched.pmgr.CheckpointProc(sp.Tpid(req.PidStr), sp.Trealm(req.RealmStr), req.PathName); err != nil {
		res.OK = false
		return err
	}
	res.OK = true
