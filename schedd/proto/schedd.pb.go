...
type GetProcRequest struct {
	...
	FreeCores int64 `protobuf:"varint,1,opt,name=freeCores,proto3" json:"freeCores,omitempty"`
...
func (x *GetProcRequest) GetFreeCores() int64 {
	if x != nil {
		return x.FreeCores
	}
	return 0
...
func (x *GetProcRequest) GetMem() int64 {
	if x != nil {
		return x.Mem
	}
	return 0
...
var file_schedd_proto_schedd_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x09, 0x66, 0x72, 0x65, 0x65, 0x43, 0x6f, 0x72, 0x65, 0x73, 0x12, 0x10, 0x0a,
	0x03, 0x6d, 0x65, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x6d, 0x65, 0x6d, 0x22,
