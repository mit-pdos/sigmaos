...
func (x *Tfenceid) Reset() {
	*x = Tfenceid{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessp_proto_msgTypes[0]
...
func (*Tfenceid) Descriptor() ([]byte, []int) {
	return file_sessp_proto_rawDescGZIP(), []int{0}
}
...
func (x *Tfence) Reset() {
	*x = Tfence{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessp_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Tfence) Descriptor() ([]byte, []int) {
	return file_sessp_proto_rawDescGZIP(), []int{1}
}
...
func (x *Tinterval) Reset() {
	*x = Tinterval{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessp_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Tinterval) Descriptor() ([]byte, []int) {
	return file_sessp_proto_rawDescGZIP(), []int{2}
}
...
func (x *Fcall) Reset() {
	*x = Fcall{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessp_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Fcall) Descriptor() ([]byte, []int) {
	return file_sessp_proto_rawDescGZIP(), []int{3}
}
...
var File_sessp_proto protoreflect.FileDescriptor

var file_sessp_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x73, 0x65, 0x73, 0x73, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3a, 0x0a,
	...
	0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x22, 0x33,
	...
	,
}

var (
	file_sessp_proto_rawDescOnce sync.Once
	file_sessp_proto_rawDescData = file_sessp_proto_rawDesc
)

func file_sessp_proto_rawDescGZIP() []byte {
	file_sessp_proto_rawDescOnce.Do(func() {
		file_sessp_proto_rawDescData = protoimpl.X.CompressGZIP(file_sessp_proto_rawDescData)
	})
	return file_sessp_proto_rawDescData
}

var file_sessp_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_sessp_proto_goTypes = []interface{}{
	(*Tfenceid)(nil),  // 0: Tfenceid
	(*Tfence)(nil),    // 1: Tfence
	(*Tinterval)(nil), // 2: Tinterval
	(*Fcall)(nil),     // 3: Fcall
}
var file_sessp_proto_depIdxs = []int32{
...
func init() { file_sessp_proto_init() }
func file_sessp_proto_init() {
	if File_sessp_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_sessp_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sessp_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Tfence); i {
			case 0:
				return &v.state
			case 1:
		...
		file_sessp_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sessp_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Fcall); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sessp_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sessp_proto_goTypes,
		DependencyIndexes: file_sessp_proto_depIdxs,
		MessageInfos:      file_sessp_proto_msgTypes,
	}.Build()
	File_sessp_proto = out.File
	file_sessp_proto_rawDesc = nil
	file_sessp_proto_goTypes = nil
	file_sessp_proto_depIdxs = nil
}
