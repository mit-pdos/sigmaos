...
func (s *Session) Dispatch(msg sessp.Tmsg, data []byte) (sessp.Tmsg, []byte, *sp.Rerror) {
	...
	default:
		...
		return nil, nil, sp.NewRerrorSerr(serr.NewErr(serr.TErrUnknownMsg, msg))
	}
}
