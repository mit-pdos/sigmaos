...
type Tattach struct {
	...
	Principal *Tprincipal `protobuf:"bytes,3,opt,name=principal,proto3" json:"principal,omitempty"`
...
func (x *Tattach) GetPrincipal() *Tprincipal {
	if x != nil {
		return x.Principal
	}
	return nil
...
var file_sigmap_sigmap_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x05, 0x2e, 0x54, 0x71, 0x69, 0x64, 0x52, 0x04, 0x61, 0x71, 0x69, 0x64, 0x22, 0x88,
	...
	0x12, 0x29, 0x0a, 0x09, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x54, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c,
	0x52, 0x09, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x12, 0x14, 0x0a, 0x05, 0x61,
	...
	0x04, 0x52, 0x06, 0x63, 0x6c, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x22, 0x0a, 0x07, 0x52, 0x61, 0x74,
...
var file_sigmap_sigmap_proto_depIdxs = []int32{
	...
	2,  // 7: Tattach.principal:type_name -> Tprincipal
	...
	45, // 22: Theartbeat.sids:type_name -> Theartbeat.SidsEntry
	46, // 23: Rheartbeat.sids:type_name -> Rheartbeat.SidsEntry
