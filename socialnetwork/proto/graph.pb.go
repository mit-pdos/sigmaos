...
func (x *Edge) Reset() {
	*x = Edge{}
	if protoimpl.UnsafeEnabled {
		mi := &file_socialnetwork_proto_graph_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Edge) Descriptor() ([]byte, []int) {
	return file_socialnetwork_proto_graph_proto_rawDescGZIP(), []int{8}
}

func (x *Edge) GetFollowerid() int64 {
	if x != nil {
		return x.Followerid
	}
	return 0
...
func (x *Edge) GetFolloweeid() int64 {
	if x != nil {
		return x.Followeeid
	}
	return 0
...
func (x *UseridList) Reset() {
	*x = UseridList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_socialnetwork_proto_graph_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UseridList) Descriptor() ([]byte, []int) {
	return file_socialnetwork_proto_graph_proto_rawDescGZIP(), []int{9}
}

func (x *UseridList) GetUserids() []int64 {
	if x != nil {
		return x.Userids
	}
	return nil
...
var file_socialnetwork_proto_graph_proto_rawDesc = []byte{
	...
	,
...
var file_socialnetwork_proto_graph_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
func file_socialnetwork_proto_graph_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_socialnetwork_proto_graph_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Edge); i {
			case 0:
				return &v.state
			case 1:
		...
		file_socialnetwork_proto_graph_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
