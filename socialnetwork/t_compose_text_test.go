...
func TestUrl(t *testing.T) {
	...
	rpcc, err := rpcclnt.MkRPCClnt([]*fslib.FsLib{snCfg.FsLib}, sp.SOCIAL_NETWORK_URL)
	assert.Nil(t, err)
...
func TestText(t *testing.T) {
	...
	// create RPC clients text
	tssn.dbu.InitUser()
	rpcc, err := rpcclnt.MkRPCClnt([]*fslib.FsLib{snCfg.FsLib}, sp.SOCIAL_NETWORK_TEXT)
	assert.Nil(t, err)
...
func TestCompose(t *testing.T) {
	...
	tssn.dbu.InitUser()
	tssn.dbu.InitGraph()
	rpcc, err := rpcclnt.MkRPCClnt([]*fslib.FsLib{snCfg.FsLib}, sp.SOCIAL_NETWORK_COMPOSE)
	assert.Nil(t, err)
	...
	assert.Nil(t, trpcc.RPC("Timeline.ReadTimeline", &arg_tl, &res_tl))
	...
	assert.Nil(t, hrpcc.RPC("Home.ReadHomeTimeline", &arg_home, &res_home))
